...
| [Bilingual platform](behavior/platform.md) | Current Django website, private accounts/notes/chats, responsive chat scrolling, placeholder API, localization, public examples, website wording approval and optional HTTPS tunnel previews. |
| [Live chat](behavior/live_chat.md) | Anymize-only live assistance and provider-owned masking/restoration, approved tester access, durable usage limits, active context, requested saving to My notes, structured cited answers with selective follow-up, German urgent-help numbers and optional developer evaluation. |

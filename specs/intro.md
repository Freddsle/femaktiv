...
| [Live chat](behavior/live_chat.md) | Anymize-only live assistance and provider-owned masking/restoration, approved tester access, durable usage limits, active context, cited evidence and optional developer evaluation. |
